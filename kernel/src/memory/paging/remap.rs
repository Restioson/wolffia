        ...
        for section in elf_sections_tag.sections() {
            ...
            unsafe {
                mapper.higher_half_map_range(
                    section.start_address() as u64..section.end_address() as u64,
                    flags,
